      ...
      <div className="wrapper-form-user-reg-auth">
          <div className="form-user-reg-auth">
               <h2>{ props.nameForm }</h2> 
                <form>
                    <div className="wrapper-input-text-user">
                        ...
                        { props.repeatPassword ?
                         <div className="wrapper-reset-pasvord"><p>Повторие ещё раз пароль</p><input type="text"className="input-text-form-user"/></div>:
                         ""}
                    </div>
                ...
                <p className="redirect-link">{props.question} <Link to={"/" + props.adressLink}>Кликните сюда</Link> </p>
          </div>
      </div>
    )
});
