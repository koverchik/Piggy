...
@section('left-column')
    <div class="h-100 p-5 bg-light rounded-3 custom-container-card">
        ...
        @else
            <img src="{{ asset('images/estimate.svg') }}" class="m-4 rounded mx-auto d-block" alt="Estimate logo"/>
            <p>The Wallet section is your go-to for monitoring and managing your actual expenses.
                Keep a detailed record of all your spending, create items for each expense, and split costs among users
                for better transparency and shared accountability.</p>
            <p> With the Wallet, you'll have a clear view of your financial outflows, helping you stay informed and in
...
@section('right-column')
    <div class="h-100 p-5 bg-light rounded-3 custom-container-card">
        ...
        @else
            <img src="{{ asset('images/wallet.svg') }}" class="m-4 rounded mx-auto d-block" alt="Wallet logo"/>
            <p>The Budget section helps you organize and plan for future expenses.
                Here, you can create and manage budget items, ensuring you stay on track with your financial goals.
                Allocate funds for upcoming purchases, events, or projects, and keep an eye on your planned
                expenditures. </p>
            <p>With detailed insights and the ability to split budget items among users, you can collaborate and ensure
