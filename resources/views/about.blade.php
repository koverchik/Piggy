        ...
        <div class="row align-items-md-stretch">
            <div class="col-md-6">
                <div class="h-100 p-5 bg-light rounded-3 custom-container-card">
                    ...
                    <img src="{{ asset('images/estimate.svg') }}" class="m-4 rounded mx-auto d-block" alt="Icon budget">
            ...
            <div class="col-md-6">
                <div class="h-100 p-5 bg-light rounded-3 custom-container-card">
                    ...
                    <img src="{{ asset('images/wallet.svg') }}" class="m-4 rounded mx-auto d-block" alt="Icon wallet">
